...
robots = ['zappa']
#  #          'babya ' 'babyb' 'blokky' 'garrix' 'gecko' 'insect' 'linkin' 'longleg'
#  # 'penguin' 'pentapod' 'queen' 'salamander' 'squarish' 'snake' 'spider'
#  # 'stingray' 'tinlicker' 'turtle' 'ww' 'zappa']
# robots = df['robot'].unique()
for i, robot in enumerate(robots):

    df = df[df['robot']==robots[i]]
    ...
    figure.savefig(path+"/databases_eval580/plot_images/individual/fitness_avg_max_lineplot_"+robot+".png", bbox_inches='tight')
