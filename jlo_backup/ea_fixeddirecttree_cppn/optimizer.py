...
import numpy as np
import sqlalchemy
from jlo.ea_fixeddirecttree_cppn.genotype import Genotype, GenotypeSerializer, crossover, develop, mutate
...
class Optimizer(EAOptimizer[Genotype, float]):
    ...
    def _mutate(self, genotype: Genotype) -> Genotype:
        return mutate(genotype, self._innov_db_brain, self._rng)
    ...
    async def _evaluate_generation(
        ...
        return [
            ...
            for environment_result in batch_results.environment_results # TODO: code from main revolve has been changed
        ]
