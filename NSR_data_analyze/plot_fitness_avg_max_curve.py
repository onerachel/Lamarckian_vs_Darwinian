...
# -*- coding: utf-8 -*-
"""
Created on Mar 7 10:47:58 2023
...
_, p_value = ttest_ind(Lamarckian_Learning['after'], Darwinian_Learning['after'], equal_var=False)
...
figure.savefig(path+"/NSR_data/plot_images/fitness_avg_max_lineplot_"+f'{task}'+".png", bbox_inches='tight')
