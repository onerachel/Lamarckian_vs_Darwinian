...
class EAOptimizer(Process, Generic[Genotype, Fitness]):
    ...
    async def __save_generation_using_session(
        ...
        bodies_develop = [BodyDevelop(10, 10, ind.genotype.body, ind.genotype.random_seed) for ind in new_individuals]
        bodies = [develop.develop()[0] for develop in bodies_develop]
