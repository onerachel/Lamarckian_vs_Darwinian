...
class Optimizer(EAOptimizer[Genotype, float]):
    ...
    async def _evaluate_generation(
        ...
        random_seeds = [genotype.random_seed for genotype in genotypes]

        for body_num, (body_genotype, brain_genotype, random_seed) in enumerate(zip(body_genotypes, brain_genotypes, random_seeds)):
            body_develop = BodyDevelop(10, 10, body_genotype, random_seed)
            ...
            new_genotypes.append(Genotype(new_body, new_brain, random_seed))
