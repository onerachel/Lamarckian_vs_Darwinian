...
class DirectTreeGenotypeConfig(object):
    def __init__(self,
                 ...
                 mutation_p_duplicate_subtree: float = 0.2,
                 mutation_p_delete_subtree: float = 0.2,
                 mutation_p_generate_subtree: float = 0.2,
                 mutation_p_swap_subtree: float = 0.2,
                 mutation_p_mutate_oscillators: float = 0.5,
                 mutation_p_mutate_oscillator: float = 0.5,
                 mutate_oscillator_amplitude_sigma: float = 0.3,
                 mutate_oscillator_period_sigma: float = 0.3,
                 mutate_oscillator_phase_sigma: float = 0.3,
                 ):
